...
namespace NicksUsedCars.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, NicksUsedCarsContext context)
        {
